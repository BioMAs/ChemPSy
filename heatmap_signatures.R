...
Input.Dir       <- "/home/genouest/irset/archives/projects/ChemPSy/processed_data/Rattus_norvegicus/ALL/5_classification/posterChemPSy/"
...
Output.Dir      <- "/home/genouest/irset/archives/projects/ChemPSy/processed_data/Rattus_norvegicus/ALL/10_Heatmap_poster_Signature"
#--------------------------------------------#
...
for (Group.Method in All.Group.Methods) {
  ...
  Out.File    <- sprintf("%s/%sHeatmap_bin_geneSign.pdf",Output.Dir,Group.Method )
  HeatMapFC(t(Reduced.Data.bin),Group.Files,Sign.Dir,Group.Signature.Files,Out.File)
  
  Out.File    <- sprintf("%s/%sHeatmap_log2fc_geneSign.pdf",Output.Dir,Group.Method )
